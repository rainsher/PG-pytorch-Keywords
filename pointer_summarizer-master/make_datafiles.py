...
cnn_tokenized_stories_dir = "D:\stanford_dm\Tokenized\cnn"
dm_tokenized_stories_dir = "D:\stanford_dm\Tokenized\dm"
finished_files_dir = "D:\CNNDM\Finished_files"
...
def chunk_file(set_name):
  in_file = 'D:/CNNDM/Finished_files/%s.bin' % set_name
...
def write_to_bin(url_file, out_file, makevocab=False):
  ...
  with open(out_file, 'wb') as writer:
    for idx,s in enumerate(story_fnames):
      if idx % 1000 == 0:
        print ("Writing story %i of %i; %.2f percent done" % (idx, num_stories,
      ...
      Keywords = keywords.keywords(article)
...
if __name__ == '__main__':
  ...
  cnn_stories_dir = 'D:\CNNDM\cnn_stories\cnn\stories'
